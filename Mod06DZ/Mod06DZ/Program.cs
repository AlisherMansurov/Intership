...
namespace Mod06DZ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //person.FirstName = "Alisher";
            //person.LastName = "Mansurov";
            //person.Age = 21;
            //Console.WriteLine(Person.GetPersonInfo(person));

            //TASK2
            //Console.WriteLine(Constants.StringConstant);
            //Console.WriteLine(Constants.IntConstant);
